...
def get_yolo_boxes(model, images, net_h, net_w, anchors, obj_thresh, nms_thresh):
    ...
    # run the prediction - use predict() for TF2 compatibility
    ...
    # Convert any TensorFlow tensors to numpy
    batch_output = [np.array(out) if hasattr(out, 'numpy') else out for out in batch_output]

...
const getTranslatedMessage = (violationType, lang) => {
  ...
  if (violationType === 'Restricted Zone Entry') {
    if (lang === 'hi-IN') return 'चेतावनी। प्रतिबंधित क्षेत्र में प्रवेश हुआ है।';
    if (lang === 'mr-IN') return 'इशारा. प्रतिबंधित क्षेत्रात प्रवेश झाला आहे.';
    return 'Warning. Worker entered restricted zone.';
  }

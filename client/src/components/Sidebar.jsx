        ...
        {location.pathname === '/' && (
          <div className="mt-6 pt-6 border-t border-slate-700/50">
            ...
            <div className="space-y-3 px-2">
              ...
              {/* Yellow - Equipment Only */}
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 rounded-full bg-yellow-500 flex-shrink-0" />
                  <span className="text-yellow-400 font-bold text-[10px] uppercase tracking-wide">Equipment Only</span>
                </div>
                <p className="text-slate-400 text-[9px] leading-relaxed pl-5">
                  Equipment detected but <span className="text-yellow-400 font-semibold">not worn</span> by person
                </p>
              </div>
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-orange-400 font-bold text-[10px] uppercase tracking-wide">Zone Alert</span>
                </div>
                <p className="text-slate-400 text-[9px] leading-relaxed pl-5">
                  Unauthorized entry into <span className="text-orange-400 font-semibold">restricted zone</span>
                </p>
              </div>
            </div>
          </div>
